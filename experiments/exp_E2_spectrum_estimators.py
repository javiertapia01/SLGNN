...
Uso:
    python experiments/exp_E2_spectrum_estimators.py --checkpoint checkpoints/gravity_rollout/xxx.pt
"""
...
def main() -> int:
    ...
    if ckpt is None:
        ...
        print("  python scripts/train.py --config configs/gravity_rollout.yaml")
