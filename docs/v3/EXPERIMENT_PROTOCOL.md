...
([tests/v3/test_integrator.py](../../tests/v3/test_integrator.py)):
...
**Gate:** los 105 tests de `tests/v3` en `float64`.
...
Cada corrida escribe `results/v3_mvp/**/<run_id>/` con `config_resolved.yaml`,
...
python scripts/v3/compare.py --experiment configs/experiments/gravity60_small.yaml \
