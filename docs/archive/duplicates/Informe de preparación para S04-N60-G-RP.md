...
1. Crear:
   ...
   ```text
   configs/S03_R1_retention.yaml
   scripts/recover_S03_retention.py
   ```
...
```text
checkpoints/S03_R1_retention/<lineage>/best-N60-ZG.pt
checkpoints/S03_R1_retention/<lineage>/best-retention.pt
checkpoints/S03_R1_retention/<lineage>/best-joint.pt
checkpoints/S03_R1_retention/<lineage>/promoted-to-S04-N60-G-RP.pt
results/S03_R1_retention/<lineage>/manifest.json
results/S03_R1_retention/<lineage>/interpolation_audit.json
results/S03_R1_retention/<lineage>/head_swap_diagnostics.json
results/S03_R1_retention/<lineage>/retention_PP2O_PW1.json
results/S03_R1_retention/<lineage>/N60_ZG_CASE06_metrics.json
results/S03_R1_retention/<lineage>/RESULTADOS.md
```
...
1. Crear:
   ...
   ```text
   configs/S04_N60_G_RP.yaml
   scripts/train_S04_N60_G_RP.py
   ```
...
```text
results/S04_N60_G_RP/<campaign>/preflight_data.json
```
...
```text
results/S04_N60_G_RP/<campaign>/preflight_baseline.json
results/S04_N60_G_RP/<campaign>/head_responsibility.json
results/S04_N60_G_RP/<campaign>/smoke_test.json
```
...
- [ ] existen `configs/S04_N60_G_RP.yaml` y `scripts/train_S04_N60_G_RP.py`;
...
python scripts/recover_S03_retention.py --config configs/S03_R1_retention.yaml --preflight
python scripts/recover_S03_retention.py --config configs/S03_R1_retention.yaml --smoke
python scripts/recover_S03_retention.py --config configs/S03_R1_retention.yaml

# 2. Pre-flight de S04, sin entrenamiento
python scripts/train_S04_N60_G_RP.py --config configs/S04_N60_G_RP.yaml --preflight

# 3. Smoke test aislado
python scripts/train_S04_N60_G_RP.py --config configs/S04_N60_G_RP.yaml --smoke

# 4. Entrenamiento formal, sólo tras aprobar los pasos anteriores
python scripts/train_S04_N60_G_RP.py --config configs/S04_N60_G_RP.yaml
```
