...
VARIANTS = {
    "v3_c": ("slgnn_v3", "configs/slgnn_v3/mvp_c.yaml"),
    "v3_c_tau": ("slgnn_v3", "configs/slgnn_v3/v3_c_tangential.yaml"),
    "v3_i": ("slgnn_v3", "configs/slgnn_v3/mvp_i.yaml"),
    "gns_controlled": ("gns_controlled", "configs/gns/controlled.yaml"),
}
DEFAULT_VARIANTS = ("v3_c", "v3_i", "gns_controlled")
...
def main() -> int:
    ...
    ap.add_argument("--models", nargs="+", default=list(DEFAULT_VARIANTS),
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "results/slgnn_v3/compare")
    args = ap.parse_args()
