...
esperar de cómputo en CPU. No repite la arquitectura (ver
`docs/slgnn_v2/architecture/SLGNN_versión2.txt`)
...
entrenamiento (`scripts/slgnn_v2/mini_train.py`) que hace overfit del benchmark de 2
...
`docs/slgnn_v2/architecture/SLGNN_versión2.txt`), adaptado a lo que el código ya ofrece y a lo que falta
por agregar.
...
Sigue el orden de §35 de `docs/slgnn_v2/architecture/SLGNN_versión2.txt`, con el mapeo concreto a los
